                    ...
                    <div className="bg-black/40 backdrop-blur-sm rounded-2xl p-8 lg:p-10 border border-white/10 hover:border-white/20 transition-all duration-300 relative h-full">
                      ...
                      <div className="text-center">
                        <motion.div
                          ...
                          className={`inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br ${service.color} p-5 mb-8 group-hover:shadow-lg group-hover:shadow-violet-500/20 transition-all duration-300`}
                        >
                        ...
                        <p className="text-violet-300 font-medium mb-6">{service.subtitle}</p>
                        ...
                        <motion.div 
                          className="flex items-center justify-center text-violet-400 group-hover:text-purple-400 transition-colors duration-200"
                          whileHover={{ x: 5 }}
                        >
                ...
                >
                  ...
                  <div className="bg-black/40 backdrop-blur-sm rounded-2xl p-8 lg:p-10 border border-white/10 hover:border-white/20 transition-all duration-300 relative h-full">
                    ...
                    <div className="flex items-start gap-6">
                      <motion.div
                        whileHover={{ scale: 1.05 }}
                        className={`flex-shrink-0 w-16 h-16 rounded-xl bg-gradient-to-br ${service.color} p-4 flex items-center justify-center group-hover:shadow-lg group-hover:shadow-violet-500/20 transition-all duration-300`}
                      >
                        <service.icon className="w-8 h-8 text-white" />
                      </motion.div>
                      <div className="flex-1">
                        <h3 className="text-xl font-bold text-white mb-3 group-hover:text-violet-400 transition-colors duration-300">{service.title}</h3>
