  ...
  return (
    <div className="h-screen flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        <h1 className="font-press-start-2p text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl 2xl:text-[10rem] bg-gradient-to-b from-white via-blue-400 to-blue-600 bg-clip-text text-transparent cursor-pointer hover:scale-105 transition-transform duration-300 tracking-tight leading-none pl-4 sm:pl-6 md:pl-8 lg:pl-10">
          PIXSELL
        </h1>
