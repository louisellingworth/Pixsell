      ...
      <div className="relative pt-16">
        ...
        <section className={sectionClasses}>
          <div className={containerClasses}>
            <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center max-w-7xl mx-auto w-full translate-y-[-2vh] sm:translate-y-[-8vh]">
              {/* Content */}
              <motion.div
              ...
              <motion.div
                ...
                className="relative flex items-center justify-center h-full order-1 md:order-2 py-4 md:py-0 mt-4 sm:mt-0"
              >
                <motion.div
                  ...
                  className="relative w-[160px] h-[160px] sm:w-[250px] sm:h-[250px] md:w-[300px] md:h-[300px] lg:w-[350px] lg:h-[350px] max-w-full"
                >
                  <motion.div
                    animate={shouldReduceMotion ? {} : {
                      scale: [1, 1.1, 1],
                    ...
                    className="absolute inset-0 bg-gradient-to-r from-purple-500/30 via-pink-500/30 to-purple-500/30 rounded-full blur-[60px] animate-pulse opacity-75 md:opacity-100"
                  />                                 
                  ...
                  <div className="relative z-10">
                    <img
                      ...
                      height={400}
                      loading="eager"
                      className="object-contain w-[160px] h-[160px] sm:w-[250px] sm:h-[250px] md:w-[300px] md:h-[300px] rounded-full drop-shadow-[0_0_30px_rgba(168,85,247,0.5)] filter brightness-125"
                    />
                  </div>
                </motion.div>
              </motion.div>
          ...
          <div className="max-w-7xl mx-auto relative">
            ...
            <div className="grid md:grid-cols-2 gap-16">
              ...
              >
                {[
                  ...
                  },
                  {
                    ...
                    description: "We work with the co-publisher to provide local customer support and continuously optimises game performance, ensuring they meet their obligations.",
                    icon: CogIcon
                  }
                ].map((step, index) => (
                  <motion.div
              ...
              <motion.div
                ...
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true }}
                className="backdrop-blur-sm bg-gradient-to-br from-emerald-900/20 via-black/30 to-emerald-900/20 border border-emerald-500/30 rounded-2xl p-8 hover:border-emerald-500/50 transition-all duration-300 h-fit sticky top-24 shadow-xl shadow-emerald-500/10 group"
              >
                <div className="absolute inset-0 bg-gradient-to-br from-emerald-500/5 to-emerald-900/5 opacity-0 group-hover:opacity-100 transition-all duration-300 rounded-2xl" />
                <h3 className="text-3xl font-bold text-emerald-100 mb-8 relative">
                  Why Choose This Model?
                  <div className="h-1 w-20 bg-gradient-to-r from-emerald-500 to-emerald-400 rounded-full mt-4" />
                </h3>
                <div className="space-y-6 relative">
                  {[
                    { text: 'No IP Loss – You keep full control of your game.', icon: ShieldCheckIcon },
                    { text: 'Risk-Free Entry – No upfront investment, just a revenue-share model.', icon: SparklesIcon },
                    { text: 'Local Expertise – Your game gets the best marketing and support in China.', icon: ChartBarIcon },
                ...
                >
                  <Link
                    href="/contact"
                    className="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-xl font-semibold text-white transition-all duration-300 hover:shadow-lg hover:shadow-emerald-500/20 group transform hover:scale-[1.02]"
                  >
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Compare different approaches to entering the Chinese gaming market and discover why developers trust us
              </p>
            </motion.div>
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                  <div className="flex-1 text-center md:text-left">
                    ...
                    <p className="text-gray-300 text-lg max-w-xl">
                      Whether you're just exploring your options or actively planning your entry, we'd love to have a chat to help you find the best approach for your game.
                    </p>
                  </div>
            ...
            >
              ...
              <h3 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-white via-purple-100 to-white bg-clip-text text-transparent">
                Experience the Pixsell Advantage
              </h3>
        ...
        <section className="container mx-auto px-4 relative mt-32">
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-100 leading-relaxed max-w-3xl mx-auto">
                From market entry to localization, we provide end-to-end support for developers looking to reach Chinese players.
              </p>
            </motion.div>
        ...
        <section className="container mx-auto px-4 py-24 relative">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                A structured timeline for securing the right co-publisher and executing a successful Steam Global launch in China
              </p>
            </motion.div>
